...
require_line '    # Firefox/WebKit 脚本保留 20 分钟、Chromium 21 分钟硬截止；作业另预留 LFS、npm、浏览器依赖安装与清理预算。' "$frontend_workflow"
...
require_line '    # Windows 软件渲染截图受脚本 21 分钟硬截止；额外预算只覆盖安装、生产构建与 Edge 事务门禁。' "$frontend_workflow"
