...
骨骼动画。项目特别瞄准经过验证的 PixiJS 6 代与对应的 pixi-spine 3 代，同时把所有引擎代码与
内容构建为净室的原创实现。
...
所有游戏专属代码、名称、场景、纹理、骨骼、动画、音频与字体为原创或单独授权。没有任何第三方
商业游戏 bundle 或资产被复制、反编译进本项目，或用作协议兼容目标。
