...
function kingUpgradeLadderRound(): FixtureRound {
  const events: FeatureEvent[] = [
    ...
    },
    {
      ...
      prize: "GRAND", multiplier: 1_000, amountMinor: "50000",
    },
  ...
  return {
    ...
    wins: [],
    events,
    featureState: activeFeatureState("OVERDRIVE", 6, 8, "250000"),
  };
}
...
const SCENARIOS: Readonly<Record<VisualFixtureScenarioName, FixtureScenario>> = {
  ...
  "king-upgrade-ladder": {
    ...
    rounds: [
      ...
      kingIdleRound(5, "250000"),
      kingIdleRound(4, "250000"),
      kingIdleRound(3, "250000"),
      kingIdleRound(2, "250000"),
      kingIdleRound(1, "250000"),
      kingIdleRound(0, "250000", true),
    ],
  },
  "kong-flow": {
    initialFeatureState: BASE_FEATURE,
